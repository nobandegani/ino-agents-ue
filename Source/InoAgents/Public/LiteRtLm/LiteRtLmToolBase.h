 ...
 * JSON schema by ULiteRtLmToolBase::BuildSchemaJson().
 */
USTRUCT(BlueprintType)
struct FLiteRtLmToolParameter
{
    GENERATED_BODY()
...
class INOAGENTS_API ULiteRtLmToolBase : public UObject
{
    GENERATED_BODY()
