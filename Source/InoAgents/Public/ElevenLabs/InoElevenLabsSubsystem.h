...
class INOAGENTS_API UInoElevenLabsSubsystem : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "InoAgents|ElevenLabs")
    EInoElevenLabsOutputFormat GetDefaultOutputFormat() const { return CachedDefaultOutputFormat; }

    /**
     * Re-reads UElevenLabsSettings into the cached fields without
     * restarting PIE. Exposed to Blueprint and to the
     * Ino.ElevenLabs.ReloadSettings console command so devs can
...
private:
    ...
    EInoElevenLabsOutputFormat CachedDefaultOutputFormat = EInoElevenLabsOutputFormat::Mp3_44100_128;
