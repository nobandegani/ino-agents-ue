...
#include "InoAgentsStreamingSoundWave.generated.h"
 ...
 *
 * Extends UInoAgentsImportedSoundWave with runtime append APIs: fed
 ...
 *
 * Typical lifecycle:
 *   Wave = UInoAgentsStreamingSoundWave::CreateStreamingSoundWave();
 *   Wave->SetInitialDesiredSampleRate(16000);
 *   Wave->SetInitialDesiredNumChannels(1);
 *   AudioComp->SetSound(Wave);
 *   AudioComp->Play();
 *   // ...later, from any thread:
 *   Wave->AppendAudioDataFromRAW(ChunkBytes, EInoAgentsRAWAudioFormat::Int16, 16000, 1);
 *   // ...eventually:
...
class INOAGENTS_API UInoAgentsStreamingSoundWave : public UInoAgentsImportedSoundWave
{
    GENERATED_BODY()

public:
    UInoAgentsStreamingSoundWave(const FObjectInitializer& ObjectInitializer);
    ...
    static UInoAgentsStreamingSoundWave* CreateStreamingSoundWave();
