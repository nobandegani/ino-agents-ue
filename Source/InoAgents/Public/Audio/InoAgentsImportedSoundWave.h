 ...
 */
struct FInoAgentsSharedPCMBuffer
{
...
public:
    ...
    static UInoAgentsImportedSoundWave* CreateImportedSoundWave();
    ...
    UFUNCTION(BlueprintPure, Category = "InoAgents|Audio|Info")
    FInoAgentsAudioHeaderInfo GetAudioHeaderInfo() const;
    ...
    UInoAgentsImportedSoundWave* DuplicateSoundWave(bool bShareBuffer);
...
protected:
     ...
     */
    TSharedRef<FInoAgentsSharedPCMBuffer> SharedPCM =
        MakeShared<FInoAgentsSharedPCMBuffer>();
