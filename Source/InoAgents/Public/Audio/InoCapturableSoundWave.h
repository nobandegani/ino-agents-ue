...
#include "InoCapturableSoundWave.generated.h"
 ...
 *
 * Typical use:
 *   Wave = UInoCapturableSoundWave::CreateCapturableSoundWave();
...
class INOAGENTS_API UInoCapturableSoundWave : public UInoStreamingSoundWave
{
    GENERATED_BODY()

public:
    UInoCapturableSoundWave(const FObjectInitializer& ObjectInitializer);
    ...
    static UInoCapturableSoundWave* CreateCapturableSoundWave();
     ...
     *                  FInoAudioInputDeviceInfo::DeviceId (parsed
...
private:
     ...
     * support capture.
     */
    TPimplPtr<FInoAudioCaptureState> CaptureState;
