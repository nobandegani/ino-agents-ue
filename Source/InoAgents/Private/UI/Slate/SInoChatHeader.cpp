...
namespace
{
    ...
    FButtonStyle MakeIconButtonStyle(const TSharedPtr<FInoChatStyle>& Style)
    {
        FButtonStyle Out;
        FSlateBrush Empty;
...
void SInoChatHeader::Construct(const FArguments& InArgs)
{
    Style          = InArgs._Style;
    ...
    [
        ...
        [
            SAssignNew(StatusDot, SInoStatusDot)
            .Style(Style)
        ]
        + SHorizontalBox::Slot()
        .AutoWidth()
        ...
        [
            ...
            .OnClicked(this, &SInoChatHeader::HandleThemeClicked)
        ...
        [
            ...
            .ButtonStyle(&IconButtonStyle)
            .ContentPadding(FMargin(6.f, 4.f))
            .OnClicked(this, &SInoChatHeader::HandleDismissClicked)
...
void SInoChatHeader::SetStreaming(bool bStreaming)
{
...
void SInoChatHeader::RefreshStyle(TSharedPtr<FInoChatStyle> InStyle)
{
    Style = InStyle;
...
FReply SInoChatHeader::HandleThemeClicked()
{
    OnThemeToggled.ExecuteIfBound();
    return FReply::Handled();
}

FReply SInoChatHeader::HandleDismissClicked()
{
