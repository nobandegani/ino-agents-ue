 ...
 */
class SInoAgentsChatInput : public SCompoundWidget
{
public:
    SLATE_BEGIN_ARGS(SInoAgentsChatInput) {}
        SLATE_ARGUMENT(TSharedPtr<FInoAgentsChatStyle>, Style)
        SLATE_EVENT(FOnInoAgentsChatMessageSubmitted, OnSubmitted)
        SLATE_EVENT(FOnInoAgentsChatCancelRequested,  OnCancelRequested)
    SLATE_END_ARGS()
...
private:
    ...
    FOnInoAgentsChatMessageSubmitted OnSubmitted;
