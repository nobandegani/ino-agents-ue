...
void SInoAgentsStatusDot::Construct(const FArguments& InArgs)
{
    Style = InArgs._Style;
...
void SInoAgentsStatusDot::SetStreaming(bool bInStreaming)
{
...
void SInoAgentsStatusDot::Tick(const FGeometry&, const double, const float)
{
...
void SInoAgentsStatusDot::SetStyle(TSharedPtr<FInoAgentsChatStyle> InStyle)
{
    Style = InStyle;
    Invalidate(EInvalidateWidgetReason::Paint);
}

FVector2D SInoAgentsStatusDot::ComputeDesiredSize(float) const
{
...
int32 SInoAgentsStatusDot::OnPaint(
