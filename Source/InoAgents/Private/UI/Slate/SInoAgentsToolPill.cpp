...
void SInoAgentsToolPill::Construct(const FArguments& InArgs)
{
    Style         = InArgs._Style;
...
FString SInoAgentsToolPill::BuildHeadlineText() const
{
...
FString SInoAgentsToolPill::BuildTooltipText() const
{
    return FString::Printf(TEXT("%s\nargs: %s\nresult: %s"),
        *ToolName.ToString(), *ArgumentsJson, *ResultJson);
}

void SInoAgentsToolPill::Tick(const FGeometry& AllottedGeometry, const double, const float)
{
...
int32 SInoAgentsToolPill::OnPaint(
