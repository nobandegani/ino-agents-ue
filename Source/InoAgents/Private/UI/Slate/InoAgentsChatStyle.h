 ...
 * outer FInoAgentsChatStyle ref atomically — bubbles that captured the prior
...
struct FInoAgentsChatStyle
{
    ...
    static TSharedRef<FInoAgentsChatStyle> MakeDark();
    static TSharedRef<FInoAgentsChatStyle> MakeLight();
};
