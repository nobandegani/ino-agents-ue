...
namespace
{
    ...
    void PopulateFonts(FInoChatStyle& S)
    {
    ...
    void PopulateBrushes(FInoChatStyle& S)
    {
...
TSharedRef<FInoChatStyle> FInoChatStyle::MakeDark()
{
    auto S = MakeShared<FInoChatStyle>();
    S->bDark = true;
...
TSharedRef<FInoChatStyle> FInoChatStyle::MakeLight()
{
    auto S = MakeShared<FInoChatStyle>();
    S->bDark = false;
