...
TPimplPtr<FInoAgentsMp3DecodeState> InoAgentsAudioMp3::CreateState()
{
    return MakePimpl<FInoAgentsMp3DecodeState>();
}

FInoAgentsMp3DecodeResult InoAgentsAudioMp3::Feed(
    FInoAgentsMp3DecodeState& State,
    const TArray<uint8>&      Bytes)
{
    FInoAgentsMp3DecodeResult Out;
