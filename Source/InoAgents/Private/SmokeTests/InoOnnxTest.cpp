...
/**
 * Console commands for validating the Phase 4 ONNX Runtime integration
 * end-to-end. Two commands:
 *
 ...
 *     already runs in FInoAgentsModule::StartupModule, useful if you
 ...
 *     (Chatterbox backbone, codec decoder, MobileNet, MNIST, whatever)
...
namespace
{
    ...
    void RunProvidersTest(const TArray<FString>& /*Args*/)
    {
        ...
        if (Api == nullptr)
        {
            UE_LOG(LogInoAgents, Error,
                   ...
                   TEXT("Check FInoAgentsModule::StartupModule logs for the reason."));
            return;
        }
        ...
        {
            UE_LOG(LogInoAgents, Log, TEXT("  [%d] %s"),
    ...
    void RunSessionFromFileTest(const TArray<FString>& Args)
    {
        ...
        UE_LOG(LogInoAgents, Log, TEXT("Ino.Onnx.SessionFromFileTest: PASS"));
    }
