...
// ============================================================================
// InoAgents.LiteRtLm.ConversationContextTest
// ============================================================================
//
...
#include "InoAgentsLiteRtLmConversationContextTest.h"
...
void UInoAgentsLiteRtLmConversationContextTestObserver::HandleModelLoaded(
    bool bSuccess, FString ErrorMessage)
{
    ...
    Conversation->OnComplete.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationContextTestObserver::HandleConversationComplete);
    Conversation->OnError.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationContextTestObserver::HandleConversationError);
...
void UInoAgentsLiteRtLmConversationContextTestObserver::HandleConversationComplete(
    FString FullText)
{
...
void UInoAgentsLiteRtLmConversationContextTestObserver::HandleConversationError(
...
void UInoAgentsLiteRtLmConversationContextTestObserver::Finish()
{
    if (Conversation)
    {
...
static void RunLiteRtLmConversationContextTest(const TArray<FString>& Args)
{
    ...
    {
        UE_LOG(LogInoAgents, Error,
               TEXT("ConversationContextTest: could not find a ULiteRtLmSubsystem. "
                    "Start PIE first — ULiteRtLmSubsystem is a UGameInstanceSubsystem "
                    "and only exists while a game instance is active."));
        return;
    }

    UInoAgentsLiteRtLmConversationContextTestObserver* Observer =
        NewObject<UInoAgentsLiteRtLmConversationContextTestObserver>();
    ...
    OnLoaded.BindDynamic(
        Observer,
        &UInoAgentsLiteRtLmConversationContextTestObserver::HandleModelLoaded);
...
static FAutoConsoleCommand GLiteRtLmConversationContextTestCommand(
    TEXT("InoAgents.LiteRtLm.ConversationContextTest"),
