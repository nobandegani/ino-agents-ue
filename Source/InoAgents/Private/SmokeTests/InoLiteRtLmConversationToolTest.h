...
#include "InoLiteRtLmConversationToolTest.generated.h"

class UInoLiteRtLmSubsystem;

class UInoLiteRtLmConversation;
class UInoLiteRtLmAddNumbersTool;

/**
 * One-shot observer for the Ino.LiteRtLm.ConversationToolTest
 ...
 *   2. Register a UInoLiteRtLmAddNumbersTool with the subsystem (at
 ...
 */
UCLASS()
class UInoLiteRtLmConversationToolTestObserver : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    TObjectPtr<UInoLiteRtLmAddNumbersTool> Tool = nullptr;
