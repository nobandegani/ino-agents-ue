...
// ============================================================================
// InoAgents.LiteRtLm.ConversationToolTest (milestone D.4b)
// ============================================================================
//
...
//   - ULiteRtLmSubsystem::RegisterTool accepts a ULiteRtLmAddNumbersTool
//   - ULiteRtLmSubsystem::BuildToolsJsonForConversation produces valid
...
//     InoAgents.LiteRtLm.ConversationToolTest What is 100 plus 250?
// ============================================================================

#include "InoAgentsLiteRtLmConversationToolTest.h"
...
void UInoAgentsLiteRtLmConversationToolTestObserver::HandleModelLoaded(
    bool bSuccess, FString ErrorMessage)
{
    ...
    Conversation->OnToken.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationToolTestObserver::HandleToken);
    Conversation->OnToolCalled.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationToolTestObserver::HandleToolCalled);
    Conversation->OnComplete.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationToolTestObserver::HandleConversationComplete);
    Conversation->OnError.AddDynamic(
        this, &UInoAgentsLiteRtLmConversationToolTestObserver::HandleConversationError);
...
void UInoAgentsLiteRtLmConversationToolTestObserver::HandleConversationComplete(
    FString FullText)
{
    const double Now      = FPlatformTime::Seconds();
...
void UInoAgentsLiteRtLmConversationToolTestObserver::HandleConversationError(
...
void UInoAgentsLiteRtLmConversationToolTestObserver::Finish()
{
...
static void RunLiteRtLmConversationToolTest(const TArray<FString>& Args)
{
    ...
    {
        UE_LOG(LogInoAgents, Error,
               TEXT("ConversationToolTest: could not find a ULiteRtLmSubsystem — "
                    "start PIE first."));
        return;
    }

    UInoAgentsLiteRtLmConversationToolTestObserver* Observer =
        NewObject<UInoAgentsLiteRtLmConversationToolTestObserver>();
    ...
    OnLoaded.BindDynamic(
        Observer,
        &UInoAgentsLiteRtLmConversationToolTestObserver::HandleModelLoaded);
...
static FAutoConsoleCommand GLiteRtLmConversationToolTestCommand(
    TEXT("InoAgents.LiteRtLm.ConversationToolTest"),
    TEXT("Milestone D.4b smoke test: loads the model, registers a "
         "ULiteRtLmAddNumbersTool, creates a conversation with "
