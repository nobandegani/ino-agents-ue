...
#include "InoChatterboxSubsystemTest.generated.h"
 ...
 * delegate declaration in InoChatterboxTypes.h exactly. FString is by
 ...
 */
UCLASS()
class UInoChatterboxSubsystemTestObserver : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    /** Max new tokens, forwarded to FInoChatterboxSynthesisOptions. */
