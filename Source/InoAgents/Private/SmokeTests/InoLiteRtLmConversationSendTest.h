...
#include "InoLiteRtLmConversationSendTest.generated.h"
...
/**
 * One-shot observer for the Ino.LiteRtLm.ConversationSendTest console
 ...
 */
UCLASS()
class UInoLiteRtLmConversationSendTestObserver : public UObject
{
    GENERATED_BODY()
