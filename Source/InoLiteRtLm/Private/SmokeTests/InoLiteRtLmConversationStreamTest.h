...
#include "InoLiteRtLmConversationStreamTest.generated.h"
...
/**
 * One-shot observer for the Ino.LiteRtLm.ConversationStreamTest
 ...
 */
UCLASS()
class UInoLiteRtLmConversationStreamTestObserver : public UObject
{
    GENERATED_BODY()
