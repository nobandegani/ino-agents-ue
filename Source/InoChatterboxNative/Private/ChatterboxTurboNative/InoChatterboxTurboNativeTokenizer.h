...
/**
 * FInoChatterboxTurboNativeTokenizer — GPT-2 byte-level BPE tokenizer for Chatterbox
...
public:
     ...
     */
    static TUniquePtr<FInoChatterboxTurboNativeTokenizer> LoadFromJson(
        const FString& TokenizerJsonPath,
        FString* OutError = nullptr);

    ~FInoChatterboxTurboNativeTokenizer() = default;
    FInoChatterboxTurboNativeTokenizer(const FInoChatterboxTurboNativeTokenizer&) = delete;
    FInoChatterboxTurboNativeTokenizer& operator=(const FInoChatterboxTurboNativeTokenizer&) = delete;
