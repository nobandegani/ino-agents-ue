...
/// on InoChatterboxNative — sub-modules of the plugin are reached via
...
/// property.
/// </summary>
public class InoChatterboxNative : ModuleRules
{
	public InoChatterboxNative(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = ModuleRules.PCHUsageMode.UseExplicitOrSharedPCHs;

		// Disable unity build for this module: InoChatterboxTurboNativeRunner.cpp and
		// InoChatterboxTurboNativeTest.cpp both have anonymous-namespace constants
		...
		PrivateIncludePaths.AddRange(
			new string[] {
				...
				// other with bare names (e.g. #include "InoChatterboxTurboNativeRunner.h").
				Path.Combine(ModuleDirectory, "Private", "ChatterboxTurboNative"),
		...
		PublicDependencyModuleNames.AddRange(
			new string[]
			{
				...
				"CoreUObject",      // UCLASS / USTRUCT / UENUM macros — used in
				                    // Public/ for FInoChatterboxTurboNativeVoice etc.
				"Engine",           // UGameInstanceSubsystem — UInoChatterboxTurboNativeSubsystem.
				...
				"InoOnnx",          // ONNX Runtime — the entire reason this
				                    ...
				                    // vtable used by FInoChatterboxTurboNativeRunner.
