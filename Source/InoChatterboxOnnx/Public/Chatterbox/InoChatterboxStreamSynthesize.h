...
#include "InoChatterboxStreamSynthesize.generated.h"
 ...
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FInoChatterboxStreamSynthesizeOnChunk,
 ...
 * FOnInoChatterboxSynthesisComplete one-to-one — same fields, same
 ...
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FInoChatterboxStreamSynthesizeOnComplete,
    bool,                          bSuccess,
 ...
 * — a given UInoChatterboxStreamSynthesize fires exactly one of
 ...
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInoChatterboxStreamSynthesizeOnError,
    FString, ErrorMessage);

/**
 * Latent async action that calls UInoChatterboxTtsSubsystem's streaming
 ...
 *
 * C++ usage:
 *     UInoChatterboxStreamSynthesize* Action =
 *         UInoChatterboxStreamSynthesize::StreamSynthesize(
 ...
 *   synthesis, call UInoChatterboxTtsSubsystem::CancelSynthesis —
...
public:
     ...
     * @param Voice              Reference voice. See FInoChatterboxVoice's
    ...
    static UInoChatterboxStreamSynthesize* StreamSynthesize(
    ...
    /** See the struct-level comment on FInoChatterboxStreamSynthesizeOnChunk. */
    UPROPERTY(BlueprintAssignable)
    FInoChatterboxStreamSynthesizeOnChunk OnAudioChunk;

    /** See the struct-level comment on FInoChatterboxStreamSynthesizeOnComplete. */
    UPROPERTY(BlueprintAssignable)
    FInoChatterboxStreamSynthesizeOnComplete OnComplete;

    /** See the struct-level comment on FInoChatterboxStreamSynthesizeOnError. */
    UPROPERTY(BlueprintAssignable)
    FInoChatterboxStreamSynthesizeOnError OnError;
...
private:
    ...
    FString                        PendingText;
    FInoChatterboxVoice            PendingVoice;
    FInoChatterboxSynthesisOptions PendingOptions;
    ...
    TWeakObjectPtr<UInoChatterboxTtsSubsystem> SubsystemWeak;
