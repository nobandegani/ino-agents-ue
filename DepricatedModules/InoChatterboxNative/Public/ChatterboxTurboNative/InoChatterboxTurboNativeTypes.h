...
#include "InoChatterboxTurboNativeTypes.generated.h"
 ...
 */
UENUM(BlueprintType)
enum class EInoChatterboxTurboNativeVariant : uint8
{
 ...
 */
INOCHATTERBOXNATIVE_API bool ChatterboxVariantsAreDtypeCompatible(
    EInoChatterboxTurboNativeVariant A, EInoChatterboxTurboNativeVariant B);
 ...
 */
INOCHATTERBOXNATIVE_API bool ChatterboxVariantHasFp16Activations(EInoChatterboxTurboNativeVariant V);
...
INOCHATTERBOXNATIVE_API FString ChatterboxVariantToString(EInoChatterboxTurboNativeVariant Variant);
 ...
 *  string. */
INOCHATTERBOXNATIVE_API FString ChatterboxVariantToFileSuffix(EInoChatterboxTurboNativeVariant Variant);

/** Parse a variant string (case-insensitive) into an enum value.
 *  Returns false on unknown input and leaves OutVariant untouched. */
INOCHATTERBOXNATIVE_API bool ChatterboxVariantFromString(
    const FString& InString,
    EInoChatterboxTurboNativeVariant& OutVariant);
 ...
 * is UInoChatterboxTurboNativeSubsystem::IsModelDownloaded's job.
 */
INOCHATTERBOXNATIVE_API FString ChatterboxResolveVariantDir(EInoChatterboxTurboNativeVariant Variant);
...
struct FInoChatterboxTurboNativePerformanceOptions
{
    GENERATED_BODY()
...
/**
 * What UInoChatterboxTurboNativeSubsystem::LoadModelsAsync needs to resolve
 ...
 */
USTRUCT(BlueprintType)
struct FInoChatterboxTurboNativeModelConfig
{
    GENERATED_BODY()
    ...
    EInoChatterboxTurboNativeVariant Variant = EInoChatterboxTurboNativeVariant::Q4F16;
    ...
    EInoChatterboxTurboNativeVariant SpeechEncoderVariant = EInoChatterboxTurboNativeVariant::Q4F16;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "InoAgents|Chatterbox",
              meta = (EditCondition = "bUsePerSessionVariants"))
    EInoChatterboxTurboNativeVariant EmbedTokensVariant = EInoChatterboxTurboNativeVariant::Q4F16;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "InoAgents|Chatterbox",
              meta = (EditCondition = "bUsePerSessionVariants"))
    EInoChatterboxTurboNativeVariant LanguageModelVariant = EInoChatterboxTurboNativeVariant::Q4F16;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "InoAgents|Chatterbox",
              meta = (EditCondition = "bUsePerSessionVariants"))
    EInoChatterboxTurboNativeVariant ConditionalDecoderVariant = EInoChatterboxTurboNativeVariant::Q4F16;

    /** Per-session ORT tuning — thread counts, profiling toggle. See
     *  FInoChatterboxTurboNativePerformanceOptions for the full doc on each field.
     *  Default-constructed = ORT auto, which is usually fine but not
     *  optimal on hybrid CPUs. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "InoAgents|Chatterbox")
    FInoChatterboxTurboNativePerformanceOptions Performance;
};
 ...
 */
INOCHATTERBOXNATIVE_API void ChatterboxResolveSessionVariants(
    const FInoChatterboxTurboNativeModelConfig& Config,
    EInoChatterboxTurboNativeVariant&           OutSpeechEncoder,
    EInoChatterboxTurboNativeVariant&           OutEmbedTokens,
    EInoChatterboxTurboNativeVariant&           OutLanguageModel,
    EInoChatterboxTurboNativeVariant&           OutConditionalDecoder);
 ...
 * verbatim to FInoChatterboxTurboNativeRunner::FSynthesisOptions — this struct
 ...
 */
USTRUCT(BlueprintType)
struct FInoChatterboxTurboNativeSynthesisOptions
{
    GENERATED_BODY()
 ...
 * alone. An empty FInoChatterboxTurboNativeVoice is accepted, but falls back to
 ...
 */
USTRUCT(BlueprintType)
struct FInoChatterboxTurboNativeVoice
{
    GENERATED_BODY()
 ...
 * plus diagnostic timings. Mirrors FInoChatterboxTurboNativeRunner::FSynthesisResult,
 * re-expressed as a USTRUCT so Blueprints can read the timings / token
 * counts directly without a C++ wrapper.
 */
USTRUCT(BlueprintType)
struct FInoChatterboxTurboNativeSynthesisResult
{
    GENERATED_BODY()
     ...
     *  To get the sample rate:  UInoChatterboxTurboNativeSubsystem::
 ...
 */
USTRUCT(BlueprintType)
struct FInoChatterboxTurboNativeModelEntry
{
    GENERATED_BODY()
...
/**
 * Fired once by UInoChatterboxTurboNativeSubsystem::LoadModelsAsync when the
 ...
 */
DECLARE_DYNAMIC_DELEGATE_TwoParams(FOnInoChatterboxTurboNativeModelsLoaded,
    bool, bSuccess,
    FString, ErrorMessage);

/**
 * Fired once by UInoChatterboxTurboNativeSubsystem::SynthesizeAsync per call.
 * On success, bSuccess is true, Result.AudioSamples is the 24 kHz mono
 * int16 PCM LE byte buffer (see FInoChatterboxTurboNativeSynthesisResult), and
 ...
 * what went wrong.
 */
DECLARE_DYNAMIC_DELEGATE_ThreeParams(FOnInoChatterboxTurboNativeSynthesisComplete,
    bool, bSuccess,
 ...
 */
DECLARE_DYNAMIC_DELEGATE_FourParams(FOnInoChatterboxTurboNativeDownloadProgress,
    float, Percent,
    int64, BytesReceived,
    int64, TotalBytes,
    bool,  bCompleted);
...
/**
 * Fired by UInoChatterboxTurboNativeSubsystem's streaming synthesis path
 * (UInoChatterboxTurboNativeStreamSynthesize async action) for every incremental
 ...
 */
DECLARE_DYNAMIC_DELEGATE_ThreeParams(FOnInoChatterboxTurboNativeAudioChunk,
