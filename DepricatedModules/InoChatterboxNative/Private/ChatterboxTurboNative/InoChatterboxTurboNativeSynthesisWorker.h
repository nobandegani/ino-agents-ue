 ...
 * TUniquePtr<FInoChatterboxTurboNativeSynthesisWorker> by UInoChatterboxTurboNativeSubsystem.
 ...
 */
class FInoChatterboxTurboNativeSynthesisWorker : public FRunnable
{
public:
    /**
    ...
    struct FPendingSynth
    {
         ...
         *  FInoChatterboxTurboNativeRunner::SynthesizeText. */
         ...
         *  FInoChatterboxTurboNativeSynthesisResult::AudioSamples format so consumers
        ...
        FOnInoChatterboxTurboNativeAudioChunk OnAudioChunk;
    };
     ...
     */
    FInoChatterboxTurboNativeSynthesisWorker(
     ...
     */
    virtual ~FInoChatterboxTurboNativeSynthesisWorker();

    FInoChatterboxTurboNativeSynthesisWorker(const FInoChatterboxTurboNativeSynthesisWorker&) = delete;
    FInoChatterboxTurboNativeSynthesisWorker& operator=(const FInoChatterboxTurboNativeSynthesisWorker&) = delete;
    FInoChatterboxTurboNativeSynthesisWorker(FInoChatterboxTurboNativeSynthesisWorker&&) = delete;
    FInoChatterboxTurboNativeSynthesisWorker& operator=(FInoChatterboxTurboNativeSynthesisWorker&&) = delete;
...
private:
    ...
    // FInoChatterboxTurboNativeRunner on the fly, runs SynthesizeText with the
    // cancel flag, packs the result into an FInoChatterboxTurboNativeSynthesisResult,
