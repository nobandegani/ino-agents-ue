...
FString ChatterboxVariantToString(EInoChatterboxTurboNativeVariant Variant)
{
    switch (Variant)
    {
        case EInoChatterboxTurboNativeVariant::Q4F16:     return TEXT("q4f16");
        case EInoChatterboxTurboNativeVariant::FP16:      return TEXT("fp16");
        case EInoChatterboxTurboNativeVariant::Q4:        return TEXT("q4");
        case EInoChatterboxTurboNativeVariant::FP32:      return TEXT("fp32");
        case EInoChatterboxTurboNativeVariant::Quantized: return TEXT("quantized");
    }
...
FString ChatterboxVariantToFileSuffix(EInoChatterboxTurboNativeVariant Variant)
{
    ...
    if (Variant == EInoChatterboxTurboNativeVariant::FP32)
    {
        return FString();
    }
    ...
    EInoChatterboxTurboNativeVariant& OutVariant)
{
    ...
    {
        OutVariant = EInoChatterboxTurboNativeVariant::Q4F16;
        return true;
    }
    if (InString.Equals(TEXT("fp16"), ESearchCase::IgnoreCase))
    {
        OutVariant = EInoChatterboxTurboNativeVariant::FP16;
        return true;
    }
    if (InString.Equals(TEXT("q4"), ESearchCase::IgnoreCase))
    {
        OutVariant = EInoChatterboxTurboNativeVariant::Q4;
        return true;
    }
    if (InString.Equals(TEXT("fp32"), ESearchCase::IgnoreCase))
    {
        OutVariant = EInoChatterboxTurboNativeVariant::FP32;
        return true;
    }
    if (InString.Equals(TEXT("quantized"), ESearchCase::IgnoreCase))
    {
        OutVariant = EInoChatterboxTurboNativeVariant::Quantized;
        return true;
    }
    return false;
}

FString ChatterboxResolveVariantDir(EInoChatterboxTurboNativeVariant Variant)
{
    // Matches:
    ...
    //     tests (InoChatterboxTurboNativeTest.cpp).
    //
...
bool ChatterboxVariantHasFp16Activations(EInoChatterboxTurboNativeVariant V)
{
    ...
    switch (V)
    {
        case EInoChatterboxTurboNativeVariant::Q4F16:
        case EInoChatterboxTurboNativeVariant::FP16:
            return true;
        case EInoChatterboxTurboNativeVariant::Q4:
        case EInoChatterboxTurboNativeVariant::FP32:
        case EInoChatterboxTurboNativeVariant::Quantized:
            return false;
    }
    return false;
}
