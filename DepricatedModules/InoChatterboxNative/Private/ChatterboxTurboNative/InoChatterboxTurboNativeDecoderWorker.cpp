...
FInoChatterboxTurboNativeDecoderWorker::FInoChatterboxTurboNativeDecoderWorker(FDecodeTask InTask)
    : Task(MoveTemp(InTask))
{
    ...
    Thread.Reset(FRunnableThread::Create(
        this,
        TEXT("InoChatterboxTurboNativeDecoderWorker"),
        /*InStackSize=*/ 0,
        TPri_Normal));
...
FInoChatterboxTurboNativeDecoderWorker::~FInoChatterboxTurboNativeDecoderWorker()
{
    UE_LOG(LogInoAgents, Log,
...
void FInoChatterboxTurboNativeDecoderWorker::Publish(
...
void FInoChatterboxTurboNativeDecoderWorker::WaitForIdle()
{
...
bool FInoChatterboxTurboNativeDecoderWorker::HasError(FString& OutError)
{
    FScopeLock Lock(&StateLock);
    if (bHasError)
    {
...
uint32 FInoChatterboxTurboNativeDecoderWorker::Run()
{
    while (true)
    {
...
void FInoChatterboxTurboNativeDecoderWorker::Stop()
{
